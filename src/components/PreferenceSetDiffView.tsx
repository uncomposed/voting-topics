...
interface PreferenceSetDiffViewProps {
  leftPreferenceSet: PreferenceSet;
  rightPreferenceSet: PreferenceSet;
  onClose?: () => void;
}

export const PreferenceSetDiffView: React.FC<PreferenceSetDiffViewProps> = ({ 
  leftPreferenceSet, 
  rightPreferenceSet, 
  onClose 
}) => {
  const [activeTab, setActiveTab] = useState<'overview' | 'topics' | 'priorities' | 'directions'>('overview');
    ...
    <div className="diff-container">
      <div className="diff-header">
        <div className="diff-header-main">
          <h1>Preference Set Comparison</h1>
...
export const TemplateDiffView = PreferenceSetDiffView;
